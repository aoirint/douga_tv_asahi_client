...
def command_update_episodes_onefile(args):
  fetcher = DougaTvAsahiSeasonFetcher(useragent=config.useragent)
  ordered_season_id_list = load_ordered_season_id_list()
...
def main():
  ...
  parser_update_episodes = subparsers.add_parser('update_episodes_onefile')
  parser_update_episodes.set_defaults(handler=command_update_episodes_onefile)
